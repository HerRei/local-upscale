...
- Upscale video locally with source timing, rotation, and compatible audio preserved. The isolated Next Preview adds HLG/PQ preservation with HAT (10-bit HEVC, Labs), optional SDR conversion, and actual tile progress with ETA ([video support](docs/video-support.md)).
